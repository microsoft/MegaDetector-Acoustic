---
description: "How to build and deploy the MegaDetector-Acoustic MkDocs documentation site locally and to GitHub Pages."
tags:
  - MkDocs
  - documentation
  - developer guide
...
Deployment is automatic. The [GitHub Actions workflow](https://github.com/microsoft/MegaDetector-Acoustic/blob/main/.github/workflows/deploy-docs.yml) triggers on every push to `main` that touches `docs/**`, `mkdocs.yml`, or `docs-requirements.txt`.
