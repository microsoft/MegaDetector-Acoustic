...
You can also cite MegaDetector-Acoustic as software directly. The [`citation.cff`](https://github.com/microsoft/MegaDetector-Acoustic/blob/main/citation.cff) file in the repository is machine-readable and is used by GitHub's "Cite this repository" widget.
